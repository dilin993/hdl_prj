-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/GammaCorrectionHDLExample/Pixel_Str_ip_fifo_sof.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Pixel_Str_ip_fifo_sof
-- Source Path: Pixel_Str_ip/Pixel_Str_ip_axi4_stream_video_slave/Pixel_Str_ip_fifo_sof
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Pixel_Str_ip_fifo_sof IS
...
END Pixel_Str_ip_fifo_sof;


ARCHITECTURE rtl OF Pixel_Str_ip_fifo_sof IS

  -- Component Declarations
  COMPONENT Pixel_Str_ip_fifo_sof_classic
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : Pixel_Str_ip_fifo_sof_classic
    USE ENTITY work.Pixel_Str_ip_fifo_sof_classic(rtl);
...
BEGIN
  u_Pixel_Str_ip_fifo_sof_classic_inst : Pixel_Str_ip_fifo_sof_classic
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
