-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/GammaCorrectionHDLExample/Pixel_Str_ip_dut.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Pixel_Str_ip_dut
-- Source Path: Pixel_Str_ip/Pixel_Str_ip_dut
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END Pixel_Str_ip_dut;


ARCHITECTURE rtl OF Pixel_Str_ip_dut IS

  -- Component Declarations
  COMPONENT Pixel_Str_ip_src_Pixel_Stream_Gamma_Compensation
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : Pixel_Str_ip_src_Pixel_Stream_Gamma_Compensation
    USE ENTITY work.Pixel_Str_ip_src_Pixel_Stream_Gamma_Compensation(rtl);
...
BEGIN
  u_Pixel_Str_ip_src_Pixel_Stream_Gamma_Compensation : Pixel_Str_ip_src_Pixel_Stream_Gamma_Compensation
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset => reset,
              pixelIn => pixelIn,  -- ufix8
