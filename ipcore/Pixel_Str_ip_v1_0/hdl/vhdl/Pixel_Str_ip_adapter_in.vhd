-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/GammaCorrectionHDLExample/Pixel_Str_ip_adapter_in.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Pixel_Str_ip_adapter_in
-- Source Path: Pixel_Str_ip/Pixel_Str_ip_axi4_stream_video_slave/Pixel_Str_ip_adapter_in
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Pixel_Str_ip_adapter_in IS
...
END Pixel_Str_ip_adapter_in;


ARCHITECTURE rtl OF Pixel_Str_ip_adapter_in IS

  -- Component Declarations
  COMPONENT Pixel_Str_ip_adapter_in_module
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : Pixel_Str_ip_adapter_in_module
    USE ENTITY work.Pixel_Str_ip_adapter_in_module(rtl);

  -- Signals
  SIGNAL user_pixel_tmp                   : std_logic_vector(7 DOWNTO 0);  -- ufix8

BEGIN
  u_Pixel_Str_ip_Pixel_Str_ip_axi4_stream_video_slave_Pixel_Str_ip_adapter_in_Pixel_Str_ip_adapter_in_module : Pixel_Str_ip_adapter_in_module
    PORT MAP( clk => clk,
              reset => reset,
              enb => adapter_in_enable,
              data_in => stream_in_user_data,  -- ufix8
