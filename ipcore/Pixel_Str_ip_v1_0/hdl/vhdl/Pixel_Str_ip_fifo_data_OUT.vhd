-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/GammaCorrectionHDLExample/Pixel_Str_ip_fifo_data_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Pixel_Str_ip_fifo_data_OUT
-- Source Path: Pixel_Str_ip/Pixel_Str_ip_axi4_stream_video_master/Pixel_Str_ip_fifo_data_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Pixel_Str_ip_fifo_data_OUT IS
...
END Pixel_Str_ip_fifo_data_OUT;


ARCHITECTURE rtl OF Pixel_Str_ip_fifo_data_OUT IS

  -- Component Declarations
  COMPONENT Pixel_Str_ip_fifo_data_OUT_classic
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic_vector(7 DOWNTO 0);  -- ufix8
  ...
  FOR ALL : Pixel_Str_ip_fifo_data_OUT_classic
    USE ENTITY work.Pixel_Str_ip_fifo_data_OUT_classic(rtl);
  ...
  SIGNAL fifo_data_out                    : std_logic_vector(7 DOWNTO 0);  -- ufix8
  ...
  SIGNAL fifo_data_out_unsigned           : unsigned(7 DOWNTO 0);  -- ufix8
  ...
  SIGNAL fifo_num_unsigned                : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL afull_num                        : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL relop_relop1_1                   : std_logic;

BEGIN
  u_Pixel_Str_ip_fifo_data_OUT_classic_inst : Pixel_Str_ip_fifo_data_OUT_classic
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
