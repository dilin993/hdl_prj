-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/GammaCorrectionHDLExample/Pixel_Str_ip_axi4_stream_video_slave.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Pixel_Str_ip_axi4_stream_video_slave
-- Source Path: Pixel_Str_ip/Pixel_Str_ip_axi4_stream_video_slave
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Pixel_Str_ip_axi4_stream_video_slave IS
...
END Pixel_Str_ip_axi4_stream_video_slave;


ARCHITECTURE rtl OF Pixel_Str_ip_axi4_stream_video_slave IS

  -- Component Declarations
  COMPONENT Pixel_Str_ip_fifo_eol
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT Pixel_Str_ip_fifo_sof
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic;  -- ufix1
  ...
  COMPONENT Pixel_Str_ip_adapter_in
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          stream_in_user_data             :   IN    std_logic_vector(7 DOWNTO 0);  -- ufix8
  ...
  COMPONENT Pixel_Str_ip_fifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : Pixel_Str_ip_fifo_eol
    USE ENTITY work.Pixel_Str_ip_fifo_eol(rtl);

  FOR ALL : Pixel_Str_ip_fifo_sof
    USE ENTITY work.Pixel_Str_ip_fifo_sof(rtl);

  FOR ALL : Pixel_Str_ip_adapter_in
    USE ENTITY work.Pixel_Str_ip_adapter_in(rtl);

  FOR ALL : Pixel_Str_ip_fifo_data
    USE ENTITY work.Pixel_Str_ip_fifo_data(rtl);
...
BEGIN
  u_Pixel_Str_ip_fifo_eol_inst : Pixel_Str_ip_fifo_eol
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Pixel_Str_ip_fifo_sof_inst : Pixel_Str_ip_fifo_sof
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Pixel_Str_ip_Pixel_Str_ip_axi4_stream_video_slave_Pixel_Str_ip_adapter_in : Pixel_Str_ip_adapter_in
    PORT MAP( clk => clk,
              reset => reset,
              stream_in_user_data => stream_in_user_data,  -- ufix8
              ...
              user_pixel => user_pixel_tmp,  -- ufix8
  ...
  u_Pixel_Str_ip_fifo_data_inst : Pixel_Str_ip_fifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              In_rsvd => AXI4_Stream_Video_Slave_TDATA,  -- ufix8
              Push => AXI4_Stream_Video_Slave_TVALID,  -- ufix1
              Pop => fifo_rd_ack,  -- ufix1
  ...
  stream_in_user_valid <= empty_not AND fifo_rd_ack;
  ...
  AXI4_Stream_Video_Slave_TREADY <=  NOT full;
