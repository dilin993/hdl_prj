-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/GammaCorrectionHDLExample/Pixel_Str_ip_axi4_stream_video_master.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Pixel_Str_ip_axi4_stream_video_master
-- Source Path: Pixel_Str_ip/Pixel_Str_ip_axi4_stream_video_master
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Pixel_Str_ip_axi4_stream_video_master IS
...
END Pixel_Str_ip_axi4_stream_video_master;


ARCHITECTURE rtl OF Pixel_Str_ip_axi4_stream_video_master IS

  -- Component Declarations
  COMPONENT Pixel_Str_ip_fifo_data_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT Pixel_Str_ip_fifo_eol_out
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT Pixel_Str_ip_fifo_sof_out
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : Pixel_Str_ip_fifo_data_OUT
    USE ENTITY work.Pixel_Str_ip_fifo_data_OUT(rtl);

  FOR ALL : Pixel_Str_ip_fifo_eol_out
    USE ENTITY work.Pixel_Str_ip_fifo_eol_out(rtl);

  FOR ALL : Pixel_Str_ip_fifo_sof_out
    USE ENTITY work.Pixel_Str_ip_fifo_sof_out(rtl);
...
BEGIN
  u_Pixel_Str_ip_fifo_data_OUT_inst : Pixel_Str_ip_fifo_data_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              In_rsvd => user_pixel,  -- ufix8
              Push => fifo_push,  -- ufix1
              Pop => AXI4_Stream_Video_Master_TREADY,  -- ufix1
              Out_rsvd => AXI4_Stream_Video_Master_TDATA_tmp,  -- ufix8
              Empty => fifo_empty_data,  -- ufix1
              AFull => fifo_afull_data  -- ufix1
              );

  u_Pixel_Str_ip_fifo_eol_out_inst : Pixel_Str_ip_fifo_eol_out
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Pixel_Str_ip_fifo_sof_out_inst : Pixel_Str_ip_fifo_sof_out
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
