-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/GammaCorrectionHDLExample/Pixel_Str_ip.vhd
...
ENTITY Pixel_Str_ip IS
  PORT( IPCORE_CLK                        :   IN    std_logic;  -- ufix1
        IPCORE_RESETN                     :   IN    std_logic;  -- ufix1
        AXI4_Stream_Video_Master_TREADY   :   IN    std_logic;  -- ufix1
        AXI4_Stream_Video_Slave_TDATA     :   IN    std_logic_vector(7 DOWNTO 0);  -- ufix8
        ...
        AXI4_Stream_Video_Master_TDATA    :   OUT   std_logic_vector(7 DOWNTO 0);  -- ufix8
...
ARCHITECTURE rtl OF Pixel_Str_ip IS

  -- Component Declarations
  COMPONENT Pixel_Str_ip_axi_lite
  ...
  COMPONENT Pixel_Str_ip_axi4_stream_video_slave
    PORT( clk                             :   IN    std_logic;  -- ufix1
          ...
          AXI4_Stream_Video_Slave_TREADY  :   OUT   std_logic;  -- ufix1
          user_pixel                      :   OUT   std_logic_vector(7 DOWNTO 0);  -- ufix8
  ...
  COMPONENT Pixel_Str_ip_dut
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          dut_enable                      :   IN    std_logic;  -- ufix1
          pixelIn                         :   IN    std_logic_vector(7 DOWNTO 0);  -- ufix8
          ...
          pixelOut                        :   OUT   std_logic_vector(7 DOWNTO 0);  -- ufix8
  ...
  COMPONENT Pixel_Str_ip_axi4_stream_video_master
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Video_Master_TREADY :   IN    std_logic;  -- ufix1
          user_pixel                      :   IN    std_logic_vector(7 DOWNTO 0);  -- ufix8
  ...
  FOR ALL : Pixel_Str_ip_axi_lite
    USE ENTITY work.Pixel_Str_ip_axi_lite(rtl);

  FOR ALL : Pixel_Str_ip_axi4_stream_video_slave
    USE ENTITY work.Pixel_Str_ip_axi4_stream_video_slave(rtl);

  FOR ALL : Pixel_Str_ip_dut
    USE ENTITY work.Pixel_Str_ip_dut(rtl);

  FOR ALL : Pixel_Str_ip_axi4_stream_video_master
    USE ENTITY work.Pixel_Str_ip_axi4_stream_video_master(rtl);
  ...
  SIGNAL top_user_pixel                   : std_logic_vector(7 DOWNTO 0);  -- ufix8
  SIGNAL auto_ready_dut_enb               : std_logic;  -- ufix1
  SIGNAL dut_enable                       : std_logic;  -- ufix1
  SIGNAL ce_out_sig                       : std_logic;  -- ufix1
  SIGNAL pixelOut_sig                     : std_logic_vector(7 DOWNTO 0);  -- ufix8
  SIGNAL AXI4_Stream_Video_Master_TDATA_tmp : std_logic_vector(7 DOWNTO 0);  -- ufix8

BEGIN
  u_Pixel_Str_ip_axi_lite_inst : Pixel_Str_ip_axi_lite
  ...
  u_Pixel_Str_ip_axi4_stream_video_slave_inst : Pixel_Str_ip_axi4_stream_video_slave
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1,
              AXI4_Stream_Video_Slave_TDATA => AXI4_Stream_Video_Slave_TDATA,  -- ufix8
              ...
              user_pixel => top_user_pixel,  -- ufix8
  ...
  u_Pixel_Str_ip_dut_inst : Pixel_Str_ip_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              dut_enable => dut_enable,  -- ufix1
              pixelIn => top_user_pixel,  -- ufix8
  ...
  u_Pixel_Str_ip_axi4_stream_video_master_inst : Pixel_Str_ip_axi4_stream_video_master
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1,
              AXI4_Stream_Video_Master_TREADY => AXI4_Stream_Video_Master_TREADY,  -- ufix1
              user_pixel => pixelOut_sig,  -- ufix8
              ...
              AXI4_Stream_Video_Master_TDATA => AXI4_Stream_Video_Master_TDATA_tmp,  -- ufix8
