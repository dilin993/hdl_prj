-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/GammaCorrectionHDLExample/Pixel_Str_ip_fifo_data_OUT_classic.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Pixel_Str_ip_fifo_data_OUT_classic
-- Source Path: Pixel_Str_ip/Pixel_Str_ip_axi4_stream_video_master/Pixel_Str_ip_fifo_data_OUT/Pixel_Str_ip_fifo_data_OUT_classic
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Pixel_Str_ip_fifo_data_OUT_classic IS
...
END Pixel_Str_ip_fifo_data_OUT_classic;


ARCHITECTURE rtl OF Pixel_Str_ip_fifo_data_OUT_classic IS

  -- Component Declarations
  COMPONENT Pixel_Str_ip_SimpleDualPortRAM_generic
  ...
  FOR ALL : Pixel_Str_ip_SimpleDualPortRAM_generic
    USE ENTITY work.Pixel_Str_ip_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_Pixel_Str_ip_fifo_data_OUT_classic_ram_generic : Pixel_Str_ip_SimpleDualPortRAM_generic
